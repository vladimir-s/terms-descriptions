...
* Tests for apostrophe (https://wordpress.org/support/topic/cant-include-a-in-terms/)
* Wordpress 6.2 support
...
* Bug fixes: support of widgets in the sidebar, hooks above the loop added (https://github.com/vladimir-s/terms-descriptions/issues/4)
* Wordpress 6.0 support

= 3.4.1 =

* New feature: [terms-descriptions] shortcode added
* New feature: convert in archive descriptions option added
* New feature: support of t_use_in_post_types column added to packet upload and export to CSV
* New feature: support of t_use_in_post_types column added to export and import
* Improvement: PHPUnit 9.5 support
* Bug fix: "www." subdomain removed from SERVER_NAME in is_current_url function
* WordPress 5.9.3 support

= 3.4.0 =

* New feature: terms can be associated with post types
* WordPress 5.9.2 support
...
* Spanish translations by Juan the Wizard (https://profiles.wordpress.org/juanwizard/)

= 3.3.8 =

* New feature: Custom timeout between requests for permalinks updates
* WordPress 5.4.1 support
